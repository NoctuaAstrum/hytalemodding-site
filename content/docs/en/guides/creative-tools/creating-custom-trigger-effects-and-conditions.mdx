---
title: "Creating Custom Trigger Effects & Conditions"
description: "Learn how to create custom trigger effects and conditions for your Hytale mod."
authors:
    - name: "Neil Revin"
...
First, let's make a class that extends [TriggerEffect](https://release.server.docs.hytale.com/com/hypixel/hytale/builtin/triggervolumes/effect/TriggerEffect). This class will be the effect that is executed when the trigger volume is triggered and the conditions are met.
...
Let's first make a class that extends [TriggerCondition](https://release.server.docs.hytale.com/com/hypixel/hytale/builtin/triggervolumes/effect/TriggerCondition) and define a BuilderCodec that chains from the `BASE_CODEC`.
